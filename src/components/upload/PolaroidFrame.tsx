...
export function PolaroidFrame({
  ...
  return (
    <div
      className={cn(
        "group/polaroid relative w-full max-w-[180px] bg-white p-1.5 transition-shadow duration-200",
        selected
          ...
          <TooltipProvider delayDuration={200}>
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  type="button"
                  className="absolute right-1 top-1 z-[5] flex size-6 items-center justify-center rounded-full bg-beurre shadow-sm"
